...
export const ADMIN_ROUTES = {
  ...
  '/admin/invoices/:number/edit': {
    label: 'Edit',
    parent: '/admin/invoices/:number',
    icon: 'FileText',
    section: 'sales',
    phase: 12,
    built: true,
    title: 'Edit invoice',
    description: 'Correct the customer, devices, lines, discount, tax or travel.',
  },
  '/admin/quotes': {
    label: 'Quotes',
    parent: 'sales',
  ...
  '/admin/quotes/:id/edit': {
    ...
    phase: 7,
    title: 'Edit quote',
    description: 'Change what this quote promises, before it becomes a ticket.',
  },
  '/admin/quotes/:id': {
    label: 'Quote',
    parent: '/admin/quotes',
